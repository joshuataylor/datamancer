...
/**
 * Tests for DatamancerMacroDocumentationProvider.
 * Tests interface conformance and negative cases.
 */
class DatamancerMacroDocumentationProviderTest : BasePlatformTestCase() {

    // -- Interface conformance --

    fun testProviderCanBeInstantiated() {
        val provider = DatamancerMacroDocumentationProvider()
